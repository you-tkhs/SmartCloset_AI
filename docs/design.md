...
- 天気情報がある場合、気温・天候に明らかに合わない厚さ・素材(例:気温25℃以上でのウール等の厚手素材、気温10℃以下で半袖のみの組み合わせ)は、「羽織る」「持ち歩く」等の口実を含めて一切除外する。これは用途・シーンより優先されるハード制約であり、シーン的にアウターが欲しい場面でも気温が高ければウール等の厚手アウターは選ばない
